...
class OTPRepository:
    ...
    async def save_otp(
        ...
        """Invalidates existing active OTPs for email+purpose and creates a new one with expiration and payload."""
        ...
        # Insert new OTP with expiration interval and payload
        insert_query = """
